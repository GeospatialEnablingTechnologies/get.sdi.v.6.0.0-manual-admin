...
If you have enabled two-factor authentication from your [User Settings](../user/user-settings.md), every [Log In](log-in.md) attempt requires an additional verification step. After entering your credentials, a one-time password (OTP) is sent to your email account, and you are taken to the two-factor authentication form.
