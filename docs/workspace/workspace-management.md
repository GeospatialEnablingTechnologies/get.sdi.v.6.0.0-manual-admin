...
![Create Workspace Form](../assets/images/workspace/workspace-management-create-form.png)
...
| :---: | :--- | :--- |
| ![Workspace users icon](../assets/icons/users.png) | **[Workspace Users](#workspace-users)** | Manage the users assigned to the workspace. |
...
![Workspace Users Form](../assets/images/workspace/workspace-management-users-form.png)
...
![Edit Workspace Form](../assets/images/workspace/workspace-management-edit-form.png)
